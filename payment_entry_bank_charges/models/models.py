...
class AccountPaymentInherit(models.Model):
    ...
    bank_tax_charges = fields.Float('Bank Tax Charges')

    # @api.depends('bank_tax_id','amount')
    # def _compute_tax_charges(self):
    #     if self.bank_tax_id:
    #         self.bank_tax_charges = self.amount + (self.amount/100*self.bank_tax_id.amount)
